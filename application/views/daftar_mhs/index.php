                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href='<?php echo base_url("daftar_mhs/tambah"); ?>' data-target="#addNewEmployee" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Tambah Mahasiswa</span></a>
                            ...
                            <tr>
                               ...
                               if( ! empty($daftar_mhs)){
                                   ...
                                   echo "<tr>
                                    ...
                                    <td>".$data->jurusan."</td>
                                    <td>
                                        <a href='".base_url("daftar_mhs/ubah/".$data->nrp)."'>Ubah</a>
                                        <a href='".base_url("daftar_mhs/hapus/".$data->nrp)."'>Hapus</a>
                                    </td>
                                    </tr>";
                                    }
                                }else{
        ...
        <div id="addNewEmployee" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" action="<?php echo base_url("daftar_mhs/tambah"); ?>">
                        <div class="modal-header">                     
                            <h4 class="modal-title">Tambah Mahasiswa</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        </div>
                        <?php echo form_open("daftar_mhs/tambah"); ?>
